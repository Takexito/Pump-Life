...
class Course (
    ...
    val cardList: ArrayList<TheoryCard> = arrayListOf(TheoryCard("Card Title", "Lesson number 1. Just do it!", false), TheoryCard("Card Title2", "Lesson number 2. Just do it!", false)),
